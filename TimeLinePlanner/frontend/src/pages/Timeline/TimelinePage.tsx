  ...
  return (
    <div className="flex flex-col h-full w-full overflow-hidden">
      ...
      <div className="flex flex-row flex-shrink-0 border-b border-app-border bg-app-surface z-40">
        <div className="w-52 min-w-[13rem] flex-shrink-0 border-r border-app-border h-[72px] flex items-center pl-4 font-semibold text-app-text-main">
          Параметры
        </div>
        <div
          ref={timeHeaderRef}
        ...
        <div className="flex flex-row flex-shrink-0 border-b-2 border-app-primary/30 bg-app-surface">
          <div className="w-52 min-w-[13rem] flex-shrink-0 border-r border-app-border bg-app-surface">
            {frozenRows.map((param) => (
              <div
                key={param.id}
                className={`h-[28px] min-h-[28px] flex items-center gap-1 shadow-[0_1px_0_0_var(--color-app-border)] select-none hover:bg-app-bg/10 relative border-l-2 border-app-primary`}
              ...
              >
                ...
                <span className={`text-xs truncate ${param.level === 0 ? 'font-bold text-app-text-head' : 'font-semibold text-app-text-main'}`}>
                  {param.name}
                </span>
              </div>
            ))}
        ...
        >
          <div className="min-w-[13rem]">
            {scrollableRows.map((param) => (
              <div
                key={param.id}
                className={`h-[28px] min-h-[28px] flex items-center gap-1 shadow-[0_1px_0_0_var(--color-app-border)] select-none hover:bg-app-bg/10 relative ${
              ...
              >
                ...
                {frozenIds.has(param.id) && <Pin size={10} className="text-app-primary flex-shrink-0" />}
